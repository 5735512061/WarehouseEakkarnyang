...
@section('content')
    ...
    <div class="page-container" style="font-family: 'Noto Sans Thai', sans-serif;">
        ...
        <div class="main-content">
            <center>
                <h2 style="color: #fff;">คลังสินค้า สาขาเจ้าฟ้า</h2>
            </center>
            <center>
                @if (auth('admin')->user()->role == '3')
                    <div class="col-md-4 mt-3">
                        <a href="{{ url('/admin/chaofa/create-tyre') }}" type="button" class="btn btn-primary"><i
            ...
            @php
                ...
                $stock = DB::table('tyrechaofas')->where('stock','!=',0)->where('stock_required','ต้องสต๊อก')->sum('stock');
            ...
            <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel"
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ url('/admin/chaofa/delete-tyre') }}" method="POST"
            ...
            <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel"
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ url('/admin/chaofa/add-tyre') }}" method="POST" enctype="multipart/form-data"

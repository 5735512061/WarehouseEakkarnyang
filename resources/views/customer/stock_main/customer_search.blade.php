        ...
        <div class="main-content">
            ...
            <center>
                <div class="col-md-8 mt-3" style="margin-bottom: 15px;">
                    <form class="form-header" action="{{ url('/customer/stock-main/search') }}" method="POST">
                        {{ csrf_field() }}
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        @foreach ($searchs as $search => $value)
                                            @if (auth('customer')->user()->role == 8)
                                                @if ($value->category == 'MICHELIN' || $value->category == 'BF Goodrich')
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                            ...
                                            @elseif(auth('customer')->user()->role == 9)
                                                ...
                                                @endif
                                            @elseif(auth('customer')->user()->role != 8 && auth('customer')->user()->role != 9)
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="table-data__info">

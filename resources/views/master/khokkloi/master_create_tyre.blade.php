                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                <form action="{{url('/master/khokkloi/create-tyre')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">{{csrf_field()}}
                                    <div class="card-header">
                                    ...
                                    <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="year" name="year" placeholder="กรุณากรอกปีที่ผลิต" class="form-control" value="2018">
                                                </div>
                                            </div>
                                            @if(Auth::user()-> role == "1")
                                            <div class="row form-group">

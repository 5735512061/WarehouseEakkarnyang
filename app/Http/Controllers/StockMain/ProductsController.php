...
namespace App\Http\Controllers\StockMain;
...
class ProductsController extends Controller
{
    public function warehouse() {
        return view('/master/stock_main/master_warehouse');
    }

  	public function create_tyre() {
        $tyrecategories = Tyrecategory::get();
        return view('/master/stock_main/master_create_tyre')->with('tyrecategories',$tyrecategories);
    }

    public function createtyre(Request $request) {
        $tyre = request()->all();
        TyreStockMain::create($tyre);
        return redirect()->action('StockMain\ProductsController@create_tyre');
    }
    ...
    public function search_add_tyre(Request $request) {
        ...
        $amount += $amountadd;
        $amount = TyreStockMain::where('id',$id)->update(['amount' =>  $amount]);        
        return redirect('/master/stock_main/search?search='.$search);
    }
    ...
    public function product_tyre(Request $request) {
        ...
        return view('/master/stock_main/master_tyre')->with('page',$page)
    ...
    public function edit_tyre($id)
    {
      ...
      return view('/master/stock_main/master_tyre_edit')->with('tyre', $tyre);
    }
    ...
    public function update_tyre(Request $request)
    {
        ...
        $tyre->save();
        return redirect()->action('StockMain\ProductsController@product_tyre');
    }

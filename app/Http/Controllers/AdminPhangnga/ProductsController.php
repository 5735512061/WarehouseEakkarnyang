...
class ProductsController extends Controller
{
    ...
    public function product_max() {
        return view('/admin/phangnga/admin_max');
    }

    public function product_oil() {
        return view('/admin/phangnga/admin_oil');
    }

    public function product_battery() {
        return view('/admin/phangnga/admin_battery');
    }

    public function product_brake() {
        return view('/admin/phangnga/admin_brake');
    }

    public function product_shock() {
        return view('/admin/phangnga/admin_shock');
    }

    public function product_accessory() {
        return view('/admin/phangnga/admin_accessory');
    }
}
